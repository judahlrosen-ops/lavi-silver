export default {
  name: 'whoWeServeContent',
  title: 'Who We Serve Page Content',
  type: 'document',
  fields: [
    ...
    { name: 'aliyahTitle', title: 'Aliyah Section Title', type: 'string' },
    { name: 'aliyahTitleHe', title: 'Aliyah Section Title (Hebrew)', type: 'string' },
    ...
    { name: 'aliyahCta', title: 'Aliyah CTA Button', type: 'string' },
    { name: 'aliyahCtaHe', title: 'Aliyah CTA Button (Hebrew)', type: 'string' },
    ...
    { name: 'techContentHe', title: 'For Tech Content (Hebrew)', type: 'array', of: [{ type: 'text' }] },
    {
      ...
      type: 'object',
      fields: [
        { name: 'header1', title: 'Header 1 (Real Estate)', type: 'string' },
        { name: 'header1He', title: 'Header 1 (Hebrew)', type: 'string' },
        { name: 'header2', title: 'Header 2 (Silver)', type: 'string' },
        { name: 'header2He', title: 'Header 2 (Hebrew)', type: 'string' },
        {
          name: 'rows',
          title: 'Rows',
          type: 'array',
